...
public class MakeUp extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)throws IOException, ServletException
    {
        ...
        try
        {
            ...
            String q1 = "select * from provider where status2='false' and profession= 'Make Up' and Status4='true'";
...
"            </div>\n" +
"        </header>\n" +
"        <section class=\"heading\"><h1>List of Availiable Makeup Artists</h1></section>\n" +
