...
public class Invitation extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)throws IOException, ServletException
    {
        ...
        try
        {
            ...
            String q1 = "select * from provider where status2='false' and profession= 'Invitation Card' and Status4='true'";
...
"            </div>\n" +
"        </header>\n" +
"        <section class=\"heading\"><h1>List of Availiable Card Designer/h1></section>\n" +
