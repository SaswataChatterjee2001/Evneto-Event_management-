...
public class provider_details extends HttpServlet
{
    public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
    {
        ...
        try
        {
            ...
            String q="select * from provider where Email_id='"+nm1+"' and status2='false'";
...
"        <title>Evneto Service Provider offers</title>\n" +
...
"            </div>\n" +
"        </header>\n" +
"        <section class=\"heading\"><h1>Your Pending Offers</h1></section>\n" +
...
"            <P><font size=\"6\"> You've no Pending offer </font></p> <BR><BR><a href=provider_home.html><font color=\"white\">Go to home</font></a>\n" +
"        </div>\n" +
"    </center>\n" +
"    </body>\n" +
"</html>");
