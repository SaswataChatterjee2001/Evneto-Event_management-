...
public class photographer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)throws IOException, ServletException
    {
        ...
        try
        {
            ...
            String q1 = "select * from provider where status2='false' and profession= 'Photographer' and Status4='true'";
...
"            </div>\n" +
"        </header>\n" +
"        <section class=\"heading\"><h1>List of Availiable Photograpthers</h1></section>\n" +
