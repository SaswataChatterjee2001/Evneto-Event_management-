...
public class user_cashpay extends HttpServlet{
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
    {
        ...
        try
        {
            ...
            String nm5=(String)user.getAttribute("email");
            ...
            String q="Insert into cashpay values ('"+nm1+"','"+nm2+"','"+nm3+"','"+nm4+"','"+name+"','"+email+"',"+num+",'"+nm5+"')";
...
"            <div><P>The total amount to be paid is:</P><br><INPUT TYPE=\"text\" placeholder=\"Amount\" name=\"N1\" size=2 value="+num+" readonly></div>\n" +
